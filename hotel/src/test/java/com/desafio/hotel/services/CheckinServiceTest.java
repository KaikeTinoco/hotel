...
class CheckinServiceTest {
    ...
    void findByGuestId() {
        ...
        Mockito.when(checkinRepository.findByGuestId(guest.getId())).thenReturn(Optional.of(checkinList));
        Mockito.when(checkinService.findByGuestId(guest.getId())).thenReturn(checkinList);
    ...
    /*@Test
    void findById() {
        Mockito.doReturn(checkin).when(checkinRepository.findById(checkin.getId()));
        Mockito.doReturn(checkin).when(checkinService.findById(checkin.getId()));
